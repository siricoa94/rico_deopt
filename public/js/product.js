        ...
        if(data.product[i].ammount == 0 && data.product[i].stock == true){
            ...
            $.ajax("/api/product/" + data.product[i].id, {
                ...
                if(data.product[i].stock == true){
                    $("#productContainer").append("<div class='productCard'><p>"+data.product[i].productname+"</p><p>"+data.product[i].price+"</p><p>"+data.product[i].ammount+"</p><p>IN STOCK</p></div>").append("<button class='purchaseBtn' data-price='"+data.product[i].price+"' data-id='"+data.product[i].id+"' data-class='"+data.product[i].ammount+"'>BUY NOW</button>");
                } else {
